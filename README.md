...
### Cosmetic Manufacturing Emulsion Simulator
Population Balance Model (PBM)-based droplet distribution and quality prediction for emulsion manufacturing.
...
### Autonomous Vehicle TOR Alert Design (Human Factors Research, Team 차오름)
